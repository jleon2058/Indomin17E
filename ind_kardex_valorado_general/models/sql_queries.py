class SQLQueries:
    ...
    def get_ajuste_monto_inicial_query():
        return"""
            ...
            where am.stock_move_id is null and aj.code = 'INV' and aa.is_inventory_account is true
    ...
    def get_ajuste_precio_query():
        return"""
            ...
            left join account_account aa on (aml.account_id = aa.id)
            left join account_journal aj on (aj.id = am.journal_id)
            where am.stock_move_id is null and aj.code = 'INV' and aa.is_inventory_account is true and aml.product_id = %s 
